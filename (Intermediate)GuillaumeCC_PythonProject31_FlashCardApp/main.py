...
try:
    ...
    original_data = pandas.read_csv("./data/frenchWords.csv")
...
def is_known():
    ...
    learn_data.to_csv("data/wordsToLearn.csv", index=False)
...
card_front_png = PhotoImage(file="./images/cardFront.png")
card_back_png = PhotoImage(file="./images/cardBack.png")
